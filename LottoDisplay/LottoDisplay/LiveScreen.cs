                                ...
                                if (Convert.ToInt32(txtAwardNo.Text) < 50)
                                {
                                    ...
                                    if (dt.Rows.Count > 4)
                                    {
                                        ...
                                        for (int i = 0; i < dt.Rows.Count; i++)
                                        {
                                            ...
                                            sqlcmd = "update customer set Balance = Balance + " + Bonus +
                                                " where id = " + dt.Rows[i]["customerId"];
                                            result = commondata.MyExecuteNonQueryTran(sqlcmd);
                                            if (result == false)
                                            {
                                    ...
                                    else
                                    {
                                        sqlcmd = "SELECT id, customerId, BetUp, BetDown, Pay, Amount " +
                                            ...
                                            " WHERE RoundId = " + RoundId +
                                            " AND SubRoundNo = " + SubRoundNo +
                                            " AND BetUp < 50000 AND BetUp >= 10000 ";
                                    }
                                    dt = commondata.MyExecuteReaderTran(sqlcmd);
                                    if (dt.Rows.Count > 4)
                                    {
                                    ...
                                    if (Bonus3 == true)
                                    {
                                        sqlcmd = "SELECT id, customerId, BetUp, BetDown, Pay, Amount " +
                                            ...
                                            " WHERE RoundId = " + RoundId +
                                            " AND SubRoundNo = " + SubRoundNo +
                                            " AND BetUp < 10000  AND BetUp >= 2000";
                                    }
                                    else if (Bonus4 == true || Bonus3 == false)
                                    {
                                        sqlcmd = "SELECT id, customerId, BetUp, BetDown, Pay, Amount " +
                                            ...
                                            " WHERE RoundId = " + RoundId +
                                            " AND SubRoundNo = " + SubRoundNo +
                                            " AND BetUp < 50000  AND BetUp >= 2000";
                                    }
                                ...
                                else
                                {
                                    ...
                                    else 
                                    {
                                        sqlcmd = "SELECT id, customerId, BetUp, BetDown, Pay, Amount " +
                                            ...
                                            " WHERE RoundId = " + RoundId +
                                            " AND SubRoundNo = " + SubRoundNo +
                                            " AND BetDown < 50000 AND BetDown >= 10000 ";
                                    }
                                    dt = commondata.MyExecuteReaderTran(sqlcmd);
                                    if (dt.Rows.Count > 4)
                                    {
                                    ...
                                    if (Bonus3 == true)
                                    {
                                        sqlcmd = "SELECT id, customerId, BetUp, BetDown, Pay, Amount " +
                                            ...
                                            " WHERE RoundId = " + RoundId +
                                            " AND SubRoundNo = " + SubRoundNo +
                                            " AND BetDown < 10000  AND BetDown >= 2000";
                                    }
                                    else if (Bonus4 == true || Bonus3 == false)
                                    {
                                            sqlcmd = "SELECT id, customerId, BetUp, BetDown, Pay, Amount " +
                                                ...
                                                " WHERE RoundId = " + RoundId +
                                                " AND SubRoundNo = " + SubRoundNo +
                                                " AND BetDown < 50000  AND BetDown >= 2000";
                                    }
                                    else if (Bonus4 == false || Bonus3 == false)
                                    {
                                        sqlcmd = "SELECT id, customerId, BetUp, BetDown, Pay, Amount " +
